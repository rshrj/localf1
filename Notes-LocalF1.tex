...
\section{Degenerations of the map $\ur \mapsto J$}
...
\subsection{Distinguished special values of $\ell$ (explicit list)}
...
\subsection{Behavior at $u=\infty$ and additional special values}
...
% \subsection{Systematic checklist (``algorithm'')}
...
\subsection{Periods near $\ur = -\frac{8}{9}$}
