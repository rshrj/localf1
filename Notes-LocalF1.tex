...
\end{equation}
We see that for $\Lambda \neq 0$, the cusps are located at $u_{\pm} = \pm 2 \Lambda^3$. Similarly, $u = 0$ is the order $2$ point $j = 1728$, and $u = \infty$ is the order $3$ point $j = 0$.
...
Let us now analyze the solutions of the Picard--Fuchs system. For $\Lambda \neq 0$, the system has three regular singular points, $u = u_{\pm} = \pm 2 \Lambda^3$ and $u = \infty$. The Fuchsian data is
\begin{equation}
\begin{tabular}{c|c}
point & exponents \\
\hline
