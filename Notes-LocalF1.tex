...
\begin{gather}
  ...
  \ell \alpha_0''(\ell)+\alpha_0'(\ell)+\frac{8}{27}\alpha_1'(\ell)+\frac{512}{81}\frac{\alpha_1(\ell)}{256 \ell+27}=0, \\
...
\begin{equation}
  \begin{aligned}
    ...
    u_2(z) &= \hypF{\tfrac13}{\tfrac13}{1}{z} \log z + \sum_{k=0}^{\infty}\frac{\left(\frac{1}{3}\right)_{k}^{2}}{(k!)^{2}}\,z^{k}
