...
\end{equation}
%
This expression can be simplified using the various identities of the dilogarithm to
\begin{equation}
\begin{aligned}
Q_{1}(b)
...
Unfortunately, with the standard CAS implementation of $\Li_2$ and $\log$, we find $Q(b) \neq Q_1(b)$ for $Re(b) \leq 0$. Instead, branch redefinitions of $Q(b)$ differ in general by functions of the sort $\Delta Q(b) = P_0 + P_1 \log b$ where $P_0$ and $P_1$ are piecewise-constant functions of $b$. For $Q_1(b)$, we find the following $P_1$ and $P_0$,
\begin{equation}
  \begin{aligned}
