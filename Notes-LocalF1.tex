...
\begin{equation}
  \begin{aligned}
    \log q = 2 \pi \ii \, \tau &= \frac{8 \log \ur + 3 \log \ell + \ur (3 \log \ell +8 \log \ur) \sigma_1' +4 \ur \sigma_2' + 8 \sigma_1}{1+\ur \sigma_1'} \\
    &= \bigl(3\log \ell + 8\log \ur\bigr) + \ur + \frac{1}{2}(-1 + 32\ell)\ur^2 + \frac{1}{3}(1 + 132\ell)\ur^3 \\
