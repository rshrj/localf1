...
\begin{equation}\label{eqn:F1localmirror}
...
We saw in the last section that Nagell's algorithm turns the local mirror of $\mathbb{F}_1$ into Weierstrass form but gives a very complicated transcendental change of coordinates. A simpler change of coordinates is given by \cite{Marino:LocalF1Notes},
\begin{equation}
  \begin{aligned}
  ...
  \end{aligned}
\end{equation}
which also turns \cref{eqn:F1localmirror} into Weierstrass form $Y^2 = 4 X^3 - g_2 X - g_3$ with
\begin{equation}\label{eqn:F1localmirrorg2g3}
  \begin{aligned}
