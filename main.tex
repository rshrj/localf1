...
\begin{equation}
  \begin{aligned}
  \omega_1 =& \sum_{k,\ell\geq 0} \frac{(2k+2\ell)!}{(k!)^2 (\ell!)^2} z^{k+\ell} \lambda^{\ell}  \\
  ...
  \end{aligned}
\end{equation} 
where $H_n=\sum_{k=1}^n (1/k)$ are the harmonic numbers. 
...
\begin{equation}
      \begin{aligned}
  \varpi_2 =& \log z + 
  \sum_{k+\ell>0} \frac{(2k+2\ell-1)!}{(k!)^2 (\ell!)^2} z^{k+\ell} \lambda^{\ell}  \\
  \varpi_3 =& -\log^2 z 
...
\begin{equation}
  \begin{aligned}
  \omega_1 =& \sum_{k,\ell\geq 0} \frac{(3k+2\ell)!}{(k!)^2 (k+\ell)! (\ell!)} 
  (-u)^{-3k-2\ell} \lambda^{\ell}  \\
  \omega_2 =& (2\log z+ \log\lambda) \omega_1 - 2  
  \sum_{3k+2\ell>0} \frac{(3k+2\ell)!}{(k!)^2 (k+\ell)! (\ell!)} 
  \left( H_k + H_\ell - 2 H_{3k+2\ell} \right) 
 (-u)^{-3k-2\ell} \lambda^{\ell} 
  \end{aligned}
\end{equation} 
where $H_n=\sum_{k=1}^n (1/k)$ are the harmonic numbers. 
...
\begin{equation}
  ...
  \varpi_3 =& \log^2 u + (2\log u - \frac14 \log \lambda) \varpi_2 + \frac18 \log^2\lambda 
   - 2  
  \sum_{3k+2\ell>0} 
  \frac{(3k+2\ell)! (3k+2\ell)}{(k!)^2 \ell! (\ell+k)!} 
  \left( H_k + H_\ell - 2 H_{2k+2\ell} + \frac{1}{k+\ell} \right) 
  (-u)^{-3k-2\ell} \lambda^{\ell} 
  \end{aligned}
\end{equation}
