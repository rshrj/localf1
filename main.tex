...
\begin{equation}
\omega_1 = {}_2F_1(\tfrac12,\tfrac12;1;1-16 z), \quad 
\omega_2 = -2\pi\  {}_2F_1(\tfrac12,\tfrac12;1;1;1-16 z),
\end{equation} 
Similarly, for $\lambda=-1$, we recover \cite[A.46]{LeFloch:2024cwl}, 
\begin{equation}
\omega_1 = {}_2F_1(\tfrac14,\tfrac34;1;1-64z^2), \quad 
\omega_2 = -\pi \sqrt2\  {}_2F_1(\tfrac14,\tfrac34;1;1;1+64 z^2),
\end{equation} 
The CY periods satisfy $z\partial_z \varpi_2=\omega_1, z\partial_z \varpi_3=\omega_2$.
Hence they are obtained by integrating once with respect to $z$, \rishi{There seems to be a factor of 2 in front of the regular part of $\varpi_2$}
\begin{equation}
      \begin{aligned}
  \varpi_2 =& \log z + 
  \sum_{k+\ell>0} \frac{(2k+2\ell-1)!}{(k!)^2 (\ell!)^2} z^{k+\ell} \lambda^{\ell}  \rishi{\quad \to \quad \log z + 
...
\begin{equation}
   ...
   \end{array}
\end{equation}
we see that the A-period of the mirror curve is given by the double sum \rishi{Wrong factor in the denominator}
\begin{equation}
  \begin{aligned}
  \omega_1 =& 
  \sum_{k,\ell\geq 0} \frac{(k+2\ell)!}{(k!)^2 \rishi{\hbox{\sout{$(k)!$}} (l!)} (\ell-k)!} 
...
\begin{aligned}
    ...
    =& (8 \lambda  u-9) \left(16 \lambda ^3+\lambda  u^4-u^3-8 \lambda ^2 u^2+36 \lambda  u-27\right) \theta_u^2 \\ &
     ...
     \end{aligned}
\end{equation}\
such that $\mathcal{D}_3= u^{-3} \partial_u \mathcal{D}$. 
...
\begin{equation}
  ...
  \alpha = \frac{t_1+3}{6 u}, \quad \beta = -\frac{18 u^2}{t_1^2+3 t_1}
  \end{gathered}
\end{equation}
